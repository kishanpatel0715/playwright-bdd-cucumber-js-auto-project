...
test.describe('PracticeForm', () => {
  ...
  test('TC123459 Verify successful Practice Form submission', { tag: ['@PracticeForm'] }, async ({ When, page, And, Then }) => { 
...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":11,"pickleLine":9,"tags":["@PracticeForm"],"steps":[{"pwStepLine":7,"gherkinStepLine":6,"keywordType":"Context","textWithKeyword":"Given the user navigates to DemoQA home page","isBg":true,"stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":7,"keywordType":"Context","textWithKeyword":"And the user selects the Forms from menu","isBg":true,"stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":10,"keywordType":"Action","textWithKeyword":"When the user selects Practice Form from the sub-menu","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":11,"keywordType":"Action","textWithKeyword":"And the user enters following details:","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":23,"keywordType":"Action","textWithKeyword":"And the user submits the form","stepMatchArguments":[]},{"pwStepLine":15,"gherkinStepLine":24,"keywordType":"Outcome","textWithKeyword":"Then the form is submitted successfully","stepMatchArguments":[]},{"pwStepLine":16,"gherkinStepLine":25,"keywordType":"Outcome","textWithKeyword":"And the following details are displayed:","stepMatchArguments":[]}]},
]; // bdd-data-end